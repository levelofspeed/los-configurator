...
prune=lambda n:{k:prune(v) for k,v in n.items() if v not in (None,{},[],"")} if isinstance(n,dict) else n
...
try:
    ...
    ax1.bar(["Stock","LoS"],[oh,th],color=["#808080","#FF0000"]); ax2.bar(["Stock","LoS"],[ot,tt],color=["#808080","#FF0000"])
    ax1.set_ylim(0,ymax); ax2.set_ylim(0,ymax); ax1.set_title("HP",color="white"); ax2.set_title("Torque",color="white")
